...
(24, 'DBBL348763', 'CBL4873639484', '2024-02-14', 1, 19, '');
...
(72, 'CBL4873639484', 5000, '2024-02-14', 1, 2, ''),
(73, 'CBL4873639484', 1, '2024-02-14', 1, 19, 'Bank to bank transfer diposit.'),
(74, 'DBBL348763', 1, '2024-02-14', 2, 19, 'Bank to bank transfer withdraw.');
...
--
-- Table structure for table `tb_ppm_inline_fri`
--

CREATE TABLE `tb_ppm_inline_fri` (
  `id` int(11) NOT NULL,
  `seasion` int(11) DEFAULT NULL,
  `style` varchar(255) DEFAULT NULL,
  `po` varchar(255) DEFAULT NULL,
  `ppm` varchar(255) DEFAULT NULL,
  `inline` varchar(255) DEFAULT NULL,
  `fri` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tb_ppm_inline_fri`
--

INSERT INTO `tb_ppm_inline_fri` (`id`, `seasion`, `style`, `po`, `ppm`, `inline`, `fri`) VALUES
(1, 2, '1009876', '41000356870', 'N/A', 'N/A', 'Shanto Rabbi'),
(2, 2, '1004673', '4100098765', 'Simanta', 'Parves', 'N/A'),
(3, 1, '1009878', '4100098897', 'Simanta', 'N/A', 'N/A'),
(4, 2, '1890909', '4100023487', 'Simanta', 'N/A', 'Shanto Rabbi'),
(5, 1, '1009876', '4100098235', 'Simanta', 'Parves', 'Simanta'),
(6, 2, '1083636', '4100029827', 'N/A', 'N/A', 'Shanto Rabbi'),
(7, 1, '1009876', '4100054321', 'Simanta', 'N/A', 'N/A'),
(8, 2, '1009239', '4100034876', 'Simanta', 'Parves', 'Shanto Rabbi'),
(9, 2, '1009239', '4100034876', 'Simanta', 'Parves', 'Simanta'),
(10, 2, '1009876', '4100034876', 'Simanta', 'N/A', 'Simanta'),
(11, 2, '1009876', '4100098897', 'N/A', 'Parves', 'Shanto Rabbi');
...
(13, 'Wifi received', 2, 1200, '', 'IMG-65cdc69f0bd2b0.13582682.png');
...
--
-- Table structure for table `tb_salaryincrementdetail`
--

CREATE TABLE `tb_salaryincrementdetail` (
  `Id` int(11) NOT NULL,
  `EId` int(11) DEFAULT NULL,
  `Date` date DEFAULT NULL,
...
--
-- Dumping data for table `tb_salaryincrementdetail`
--

INSERT INTO `tb_salaryincrementdetail` (`Id`, `EId`, `Date`, `IncrementAmount`) VALUES
(1, 15, '2024-02-14', 1000),
(2, 16, '2024-02-14', 2500),
(3, 15, '2024-02-14', 1000),
(4, 1, '2024-02-14', 5000),
(5, 17, '2024-02-15', 2000);
...
INSERT INTO `tb_salaryinfo` (`Id`, `EId`, `BasicSalary`, `HouseRent`, `MedicalCost`, `Transport`, `VAT`, `ProvedentFound`, `IncrementDate`) VALUES
(1, 1, 20000, 5000, 5000, 5000, 1000, 1000, '2024-02-14'),
(2, 2, 18000, 4500, 4500, 4500, 1260, 1260, '2023-02-14'),
(3, 11, 28000, 8400, 8400, 8400, 2240, 2240, '2023-02-14'),
(4, 12, 100000, 70000, 70000, 70000, 15000, 15000, '2023-02-14'),
(5, 13, 31000, 12400, 12400, 12400, 2790, 2790, '2023-02-14'),
(6, 14, 45000, 22500, 22500, 22500, 4500, 4500, '2023-02-14'),
(7, 15, 82000, 57400, 57400, 57400, 12300, 12300, '2024-02-14'),
(8, 16, 24500, 6125, 6125, 6125, 1225, 1225, '2024-02-14'),
(9, 17, 37000, 14800, 14800, 14800, 3700, 3700, '2024-02-15'),
(10, 18, 18500, 4625, 4625, 4625, 1295, 1295, '2023-02-14'),
(12, 19, 120000, 0, 0, 0, 18000, 18000, '2023-02-14');
...
(29, 1, 1, '2024-02-13', '202402', 12, 865, 2, 1154, 1000, 200),
(30, 9, 17, '2024-03-28', '202403', 55, 9784, 2, 2846, 2000, 500),
(31, 3, 11, '2024-03-28', '202403', 80, 10769, 1, 1077, 3000, 800);
...
--
-- Table structure for table `tb_seasion`
--

CREATE TABLE `tb_seasion` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tb_seasion`
--

INSERT INTO `tb_seasion` (`id`, `name`) VALUES
(1, 'SS-24'),
(2, 'AW-24');
...
(12, 13, 1, '2024-02-15', 5, ''),
(13, 12, 1, '2024-02-15', 12, 'N/A');
...
(10, 13, 1, 12, '2024-02-15', 1),
(11, 13, 1, 13, '2024-02-15', 2),
(12, 8, 1, 17, '2024-02-15', 1),
(13, 9, 1, 14, '2024-02-15', 1),
(14, 12, 1, 2, '2024-02-15', 3);
...
--
-- Indexes for table `tb_ppm_inline_fri`
--
ALTER TABLE `tb_ppm_inline_fri`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tb_salaryincrementdetail`
--
ALTER TABLE `tb_salaryincrementdetail`
  ADD PRIMARY KEY (`Id`);
...
--
-- Indexes for table `tb_seasion`
--
ALTER TABLE `tb_seasion`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tb_ppm_inline_fri`
--
ALTER TABLE `tb_ppm_inline_fri`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- AUTO_INCREMENT for table `tb_salaryincrementdetail`
--
ALTER TABLE `tb_salaryincrementdetail`
...
--
-- AUTO_INCREMENT for table `tb_seasion`
--
ALTER TABLE `tb_seasion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
